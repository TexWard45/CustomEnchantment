...
/**
 * Tests for CommandRemoveEnchant class.
 * Tests remove enchant command registration.
 */
@DisplayName("CommandRemoveEnchant Tests")
class CommandRemoveEnchantTest {

    private CommandRemoveEnchant commandRemoveEnchant;
    ...
    void setUp() {
        ...
        commandRemoveEnchant = new CommandRemoveEnchant();
    ...
    class InterfaceTests {
        ...
        void shouldImplementCommandRegistrar() {
            assertInstanceOf(CommandRegistrar.class, commandRemoveEnchant);
        }

        @Test
        @DisplayName("should be instantiable with no-arg constructor")
        void shouldBeInstantiable() {
            assertNotNull(new CommandRemoveEnchant());
        }
    }
    ...
    class OnRegisterTests {
        ...
        @Test
        @DisplayName("should register removeenchant subcommand")
        void shouldRegisterRemoveEnchantSubCommand() {
            commandRemoveEnchant.onRegister(mockBuilder);
        ...
        void shouldRegisterCorrectPermission() {
            ...
            verify(mockBuilder).permission("customenchantment.removeenchant.other");
        }
        ...
        void shouldNotThrowOnRegister() {
            assertDoesNotThrow(() -> commandRemoveEnchant.onRegister(mockBuilder));
        }
    }
}
