...
public class CEDisplay {
	...
	public CEDisplay(String display, String customDisplayLore, boolean disableEnchantLore, List<String> description, List<String> detailDescription, List<String> appliesDescription) {
