...
public class CEEnchantConfig extends AbstractConfig {
	...
	public CEEnchant loadCEEnchant(String key, AdvancedConfigurationSection config) {
		...
		CELevelMap ceLevelMap = loadCELevels(config.getAdvancedConfigurationSection("levels"));
        ...
        String bookType = config.getString("book-type");
        List<String> enchantBlacklist = config.getStringList("enchant-blacklist");
	...
	public CELevelMap loadCELevels(AdvancedConfigurationSection config) {
