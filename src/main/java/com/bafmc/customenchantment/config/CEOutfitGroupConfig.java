...
public class CEOutfitGroupConfig extends AbstractConfig {
	protected void loadConfig() {
		...
		for (String key : groupKeys) {
			...
			CEOutfitGroup ceGroup = loadCEOutfitGroup(key, mainConfig, settingsConfig);
			CustomEnchantment.instance().getCeOutfitGroupMap().put(ceGroup.getName(), ceGroup);
		}
	}

	public CEOutfitGroup loadCEOutfitGroup(String key, AdvancedConfigurationSection mainConfig, AdvancedConfigurationSection settingsConfig) {
