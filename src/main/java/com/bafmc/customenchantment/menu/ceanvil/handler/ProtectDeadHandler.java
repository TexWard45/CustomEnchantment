...
public class ProtectDeadHandler implements Slot2Handler {
    ...
    public void updateConfirm(CEAnvilCustomMenu menu) {
        menu.updateSlots("confirm", menu.getTemplateItemStack("confirm-protect-dead"));
    }
    ...
    public ApplyReason apply(CEItem ceItem1, CEItem ceItem2) {
        if (ceItem2 instanceof CEProtectDead protectDead) {
