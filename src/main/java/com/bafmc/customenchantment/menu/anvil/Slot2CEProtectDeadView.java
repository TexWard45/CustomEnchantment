...
public class Slot2CEProtectDeadView extends AnvilSlot2View<Slot2CEProtectDeadView> {
	...
	public Slot2CEProtectDeadView(CEAnvilMenu anvilMenu) {
		super(anvilMenu);
	}

	public Slot2CEProtectDeadView instance(CEAnvilMenu anvilMenu) {
		return new Slot2CEProtectDeadView(anvilMenu);
	}
	...
	public void updateConfirm() {
		...
		menu.updateSlots("confirm", menu.getItemStack(null, "confirm-protect-dead"));
	}
