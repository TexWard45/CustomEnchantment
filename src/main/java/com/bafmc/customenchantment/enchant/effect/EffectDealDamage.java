...
public class EffectDealDamage extends EffectHook {
	...
	public void execute(CEFunctionData data) {
		...
		map.put(CEConstants.Placeholder.ENEMY_VALUE, enemy != null ? String.valueOf(data.getEnemyLivingEntity().getHealth()) : "0");
		map.put(CEConstants.Placeholder.PLAYER_MAX_VALUE, String.valueOf(player.getMaxHealth()));
		map.put(CEConstants.Placeholder.ENEMY_MAX_VALUE, enemy != null ? String.valueOf(enemy.getMaxHealth()) : "0");
